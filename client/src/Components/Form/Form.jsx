...
import { createPokemon, getAllPokemons, getPokeType } from "../../Redux/Actions";
...
function validate(input) {
  ...
  const urlvalidate = /https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_\+.~#?&//=*]*)/gi
  if (!input.name) {
    errors.name = "Se requiere un nombre";
  } else if (input.name.length > 30) {
    errors.name = "No puede tener mas de 30 caracteres";
  } else if (!whitespacesParameter.test(input.name) || !alphabeticalPattern.test(input.name)) {
    errors.name = "No puede tener caracteres especiales o numeros y debe ser mayor a una letra";
  ...
  } else if (input.hp.includes("e") || input.hp.includes(",") || input.hp.includes(".")) {
  ...
  } else if (input.attack.includes("e") || input.attack.includes(",") || input.attack.includes(".")) {
  ...
  } else if (input.defense.includes("e") || input.defense.includes(",") || input.defense.includes(".")) {
  ...
  } else if (input.speed.includes("e") || input.speed.includes(",") || input.speed.includes(".")) {
  ...
  } else if (input.height.includes("e") || input.height.includes(",") || input.height.includes(".")) {
  ...
  } else if (input.weight.includes("e") || input.weight.includes(",") || input.weight.includes(".")) {
